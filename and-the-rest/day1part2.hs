...
searched str = map (\(i, x) -> (i, Text.length . fst . Text.breakOn x $ str))

findFirstFwd str = fst . head . List.sortOn snd . searched str

findFirstBackwd str xs = findFirstFwd (Text.reverse str) (map (second Text.reverse) xs)
